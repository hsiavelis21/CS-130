...
class Workbook:
    ...
    def del_sheet(self, sheet_name: str) -> None:
        ...
        for i in range(self.num_sheets()):
            ...
            if curr_sheet.get_name().lower() == sheet_name.lower():
    ...
    def set_cell_contents(self, sheet_name: str, location: str,
        ...
        for i in range(self.num_sheets()):
            ...
            if curr_sheet.get_name().lower() == sheet_name.lower():
                ...
                return curr_sheet.set_spreadsheet_cell_contents(location, contents, self)
    ...
    def get_cell_contents(self, sheet_name: str, location: str) -> Optional[str]:
        ...
        for i in range(self.num_sheets()):
            ...
            if curr_sheet.get_name().lower() == sheet_name.lower():
                #get the cell and change contents
                return curr_sheet.get_spreadsheet_cell_contents(location)
    ...
    def get_cell_from_spreadsheet(self, sheet_name, location):
        # Return a cell from sheet_name at the specified location
